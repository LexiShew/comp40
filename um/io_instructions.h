#ifndef IO_INSTRUCTIONS_H_INCLUDED
#define IO_INSTRUCTIONS_H_INCLUDED
 ...
 *
 * This file is the interface for the I/O instructions module. This file
 * contains the declarations for all the functions that correspond to the UM
 ...
 */
extern void input(Registers_T r, int c);
...
* Expectations/errors: c must be between 0 and 7; r cannot be null; r[C] is
        between 0 and 255
 */
extern void output(Registers_T r, int c);
